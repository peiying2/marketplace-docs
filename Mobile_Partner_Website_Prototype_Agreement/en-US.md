...
| **Requirements** | Prototypes must pass the following requirements: <br><br>\*Open Source License Compliance<br>\*Pass the Open Web Device Compliance Review Board<br>\*Meet Performance and Compatibility Requirements |
